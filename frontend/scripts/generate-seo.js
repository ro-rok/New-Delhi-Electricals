...
console.log(`React prerender complete: ${routeSet.size} indexable routes (${products.length} products, 6 categories, ${brands.length} brands) from ${catalogue.source}.`);
